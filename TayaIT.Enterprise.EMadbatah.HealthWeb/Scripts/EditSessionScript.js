...
//    }
    ...
    function nextAndprev(o) {
        ...
        // pause player
        $("#jquery_jplayer_1").jPlayer("stop").jPlayer("play")
        $("#jquery_jplayer_1").jPlayer("pause", Math.floor(startTime.val()));
    }
    ...
    if(response.ItemOrder == "last")
    {
        ...
        if (response.Message == "success") {
            ...
            if (response.Item.AgendaSubItemID != null && response.Item.AgendaSubItemID != 0) {
                ...
                $("#MainContent_ddlAgendaSubItems > option[value=" + response.Item.AgendaItemID + "]").attr('selected', 'selected');
            }
            else {
            //25-03-2012 -- UN
                $("#MainContent_ddlAgendaSubItems").attr("disabled", "disabled");
            ...
            ed.onInit.add(function (ed) {
                ...
                AudioPlayer.jPlayer({
                    ...
                    ready: function () {
                        ...
                        // x seconds button
                        $('.jp-audio .jp-xseconds').click(function(e){
                ...
                $(document).add(ed.dom.doc.body).bind('keydown',function(e){
                    ...
                    // x seconds
                    $('.jp-audio .jp-xseconds').trigger('click')
